...
inquirer.prompt([
  ...
  case "View Product Sales by Department":
      connection.query("SELECT departments.departments.department_id, bamazon.products.department_name, departments.departments.department_name, departments.departments.over_head_costs, bamazon.products.product_sales FROM products INNER JOIN departments.departments ON bamazon.products.department_name=departments.departments.department_name;", function(err, res) {
      if (err) throw err;
      console.table(res);
      process.exit();
      }
